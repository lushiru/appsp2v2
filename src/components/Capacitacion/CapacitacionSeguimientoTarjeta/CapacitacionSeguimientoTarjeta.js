...
import { styles } from "./CapacitacionSeguimientoTarjeta.styles";
...
export function CapacitacionSeguimientoTarjeta({item, index }) {
    ...
    const irIndividual = async (idplan) => {
        ...
        if(colaborador != null) navigation.navigate(screensName.homeplan.capacitacionSeguimientoMostrar, {idplan: idplan, colaborador: colaborador, nombreplan: item.nombreplan});
