...
import { styles } from './CheckListTomarFotoScreen.styles';
import { Layout } from '../../../layouts';
import { checklistfotoCtrl } from '../../../api';

export function CheckListTomarFotoScreen(props) {
    ...
    const guardarFoto = async () => {
      try{
        const d = new Date();
        await checklistfotoCtrl.crearChecklistFoto(id,`foto_${d.getTime()}`,`data:image/jpeg;base64,${photo}`);
        setPhoto(null);
